...
const App = () => {
  ...
  const saveToStorage = (key, data) => {
    try {
      ...
      debug(`⚠️ Storage error: ${e.message}`);
      setStorageAvailable(false);
      return false;
    }
  };
  ...
  const exportToPDF = (viewName, contentId) => {
    ...
    debug(`✓ Content found, preparing export...`);
    ...
    debug(`✓ Popup window opened, writing content...`);
    
    printWindow.document.write(`
      <!DOCTYPE html>
      <html>
        <head>
          <title>Export ${viewName}</title>
          <style>
            @media print {
              body { margin: 20mm; }
    ...
    debug(`✓ PDF export window ready`);
    setNotification({ type: 'success', message: `${viewName} ready to export! Use Print > Save as PDF` });
    setTimeout(() => setNotification(null), 5000);
  };

  const getExportStyles = () => `
    .container { max-width: 100%; }
    h1, h2, h3, h4 { margin-top: 15px; margin-bottom: 10px; color: #1f2937; }
    ...
    .card { border: 1px solid #e5e7eb; padding: 15px; margin: 10px 0; border-radius: 8px; }
    .zone-header { background-color: #eff6ff; padding: 10px; margin: 20px 0 10px 0; border-left: 4px solid #3b82f6; }
    .price-row { font-weight: bold; background-color: #fef3c7 !important; }
  ...
  const saveToStorage = (key, data) => {
    try {
      debug(`Saving to storage: ${key}`);
      const serialized = JSON.stringify(data);
      debug(`Data size: ${(serialized.length / 1024).toFixed(2)} KB`);
  ...
  const loadFromStorage = (key) => {
    try {
      return null; // Simulated - no actual storage
    } catch (e) {
      debug(`⚠️ Load error: ${e.message}`);
      return null;
    }
          ...
          <div className="bg-white rounded-lg p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-blue-50 rounded-lg p-6">
                <h3 className="text-lg font-bold mb-3">🏠 Born from Experience</h3>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Compare multiple design options</li>
                  <li>• Track costs across products</li>
                  <li>• Generate procurement lists</li>
              ...
              <div className="bg-purple-50 rounded-lg p-6">
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  <li>• Homeowners planning renovations</li>
                  <li>• Contractors managing projects</li>
                  <li>• Interior designers</li>
                  <li>• Anyone comparing bathroom options</li>
                </ul>
              </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-4">
                💡 Tip: Click the Help button anytime for detailed guidance
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 mb-1">🚿 Bathroom Configurator</h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 mb-6">
          <div className="flex flex-wrap gap-2">
            {['database', 'bathrooms', 'configure', 'final', 'summary', 'overview', 'procurement', 'settings'].map(v => (
              <button
                key={v}
                onClick={() => setView(v)}
              ...
              >
                ...
                {v === 'configure' && '⚙️ Configure'}
                {v === 'final' && '✅ Final Selections'}
                {v === 'summary' && '📋 Summary'}
                {v === 'overview' && '🔍 Overview'}
                {v === 'procurement' && '📦 Procurement'}
        ...
        {view === 'bathrooms' && (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              {bathrooms.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  <p className="text-lg">No bathrooms yet. Click "Add Bathroom" to get started! 👆</p>
                </div>
              ) : (
              ...
              <div className="flex justify-between items-center">
                <div className="flex-1">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      const bathroom = bathrooms.find(b => b.id === parseInt(e.target.value));
                      if (bathroom) {
                                    ...
                                    {categoryItems.length === 0 ? (
                                      ...
                                      categoryItems.map(item => (
                                        ...
                                        >
                                          ...
                                          {item.series && <div className="text-xs text-gray-500">{item.series}</div>}
                                          <div className="text-sm font-bold text-blue-600 mt-1">{currency}{item.price?.toFixed(2) || '0.00'}</div>
                                        </div>
                                      ))
                                    )}
                                  </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center mb-2">
                                {isSelected && <span className="text-2xl mr-2">✅</span>}
                          ...
                          <div>
                            ...
                            <div className="flex gap-3 mt-2 text-sm">
                              <span className="bg-gray-100 px-3 py-1 rounded">
                                Importance: {bathroom.importance === 'high' ? '🔴 High' : bathroom.importance === 'medium' ? '🟡 Medium' : '🟢 Low'}
                              </span>
                              <span className="bg-gray-100 px-3 py-1 rounded">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-gray-200 rounded-lg p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <div className={`px-4 py-2 rounded-lg ${storageAvailable ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                      {storageAvailable ? '✓ Auto-save enabled - Your data is being saved automatically' : '⚠️ Storage unavailable - Please use manual backup'}
                    </div>
                  </div>

                  <button
                    onClick={() => {
                      if (confirm('⚠️ WARNING: This will permanently delete ALL your data including:\n\n• All products in database\n• All bathrooms and configurations\n• All custom categories\n• Final selections\n• Settings\n\nThis action CANNOT be undone!\n\nAre you absolutely sure you want to continue?')) {
                        clearStorage();
                        setItems([]);
                        setBathrooms([]);
                        setCustomCategories([]);
                ...
                {/* About Section */}
                <div className="border-2 border-gray-200 rounded-lg p-6">
                  <h3 className="text-xl font-bold mb-4 text-gray-800">ℹ️ About</h3>
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Built with ❤️ and Claude AI during a real bathroom renovation project
                      </p>
                    </div>
        ...
        {view === 'help' && (
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">📖 Help & Documentation</h2>
            
            <div className="space-y-6">
              {/* Quick Start */}
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg shadow p-6 border border-green-200">
                <h3 className="text-2xl font-bold mb-3 text-gray-800">🚀 Quick Start Guide</h3>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-xl font-bold mb-3">📊 Database Tab</h3>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-600 text-sm">
                  ...
                  <li><strong>Related Items:</strong> For auto-selection (e.g., diverter → concealed body)</li>
                </ul>
              </div>
              
              {/* Bathrooms Tab */}
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-xl font-bold mb-3">🚿 Bathrooms Tab</h3>
              ...
              {/* Configure Tab */}
              <div className="bg-white rounded-lg shadow p-6">
                <h3 className="text-xl font-bold mb-3">⚙️ Configure Tab</h3>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg shadow p-6 border border-yellow-200">
                <h3 className="text-xl font-bold mb-3">💡 Tips & Tricks</h3>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg shadow p-6 border border-purple-200">
                <h3 className="text-xl font-bold mb-3">☕ Support This Project</h3>
                  ...
                  {customCategories.map(cat => (
                    <div key={cat.key} className="border rounded-lg p-3 flex justify-between items-center">
                      <div>
                        ...
                        <div className="text-xs text-gray-600">
                          Zone: {cat.zone.replace('_zone', '').replace('_', ' ')} • 
                          {cat.auto && ' Auto-select •'}
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-3">
                🏠 <em>Born from the chaos of DIY house construction – when spreadsheets just weren't cutting it anymore.</em> 🏠
              </p>
            ...
            <div className="mt-6 pt-6 border-t border-gray-300">
              <p className="text-sm text-gray-700 mb-3">
                ☕ Enjoying this free tool? Support its development!
              </p>
              <a
                href="https://buymeacoffee.com/poojasengupta"
                target="_blank"
            ...
            <div className="mt-4 pt-4 border-t border-gray-300">
              ...
              <p className="text-xs text-gray-500 mt-2">
                © 2026 • Built with React • May your bathroom renovations be less stressful than mine! ✨
              </p>
            </div>
          </div>
        </footer>
